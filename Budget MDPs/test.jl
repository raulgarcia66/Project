...
B_union_vec, BB_vec, v_union_vec, vv_vec = compute_deterministic_data(states, actions, B_max, P[sub], C[sub], R[sub], Γ[sub], T);
...
###
Q_star_vec, sto_B_V_vec, sto_v_V_vec, sto_B_vec, sto_v_vec = compute_V_function_stochastic_data(BB_vec, vv_vec, states, actions, P[1], C[1], R[1], Γ[1], T);
Q_star_vec[1]
sto_B_V_vec[2][2]
sto_v_V_vec[2][2]
